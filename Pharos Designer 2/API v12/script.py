...
`REV 1.5 2026.06.15 azuell + dargs`
...
* rev. 1.5: **MAJOR:** Seperate dashboard conveniences into ingredients (Scene/TimelineOnOff, dynamic select, etc)
...
def CreateNodelSafeName(name):
  # Strips names of punctuaion without losing content within brackets
